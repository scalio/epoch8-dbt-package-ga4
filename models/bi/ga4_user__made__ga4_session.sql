...
WITH t1 AS (
    SELECT
        ...
        ga4_user__made__ga4_session.ga4_user__made__ga4_session__date
    FROM
    ...
    {% if is_incremental() %}
        ...
        WHERE
            ga4_user__made__ga4_session.ga4_user__made__ga4_session__date > DATE_SUB(DATE('{{ max_patition_date }}'), INTERVAL {{ var('VAR_INTERVAL_INCREMENTAL') }} DAY)
    {% endif %}
),
