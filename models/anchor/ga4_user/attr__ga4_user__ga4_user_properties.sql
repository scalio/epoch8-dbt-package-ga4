...
WITH t1 AS (
    SELECT
        ...
        DATE(TIMESTAMP_MICROS(events.event_timestamp)) AS ga4_user_properties_date_updated,
...
t2 AS (
    ...
    WHERE
        ...
        AND t1.ga4_user_properties_date_updated IS NOT NULL
...
final AS (
    SELECT
        t2.ga4_user_id,
        t2.ga4_user_properties_date_updated,
