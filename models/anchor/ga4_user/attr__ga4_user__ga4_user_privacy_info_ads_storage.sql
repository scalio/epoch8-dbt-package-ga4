...
WITH t1 AS (
    SELECT
        ...
        events.privacy_info.ads_storage AS ga4_user_privacy_info_ads_storage,
...
t2 AS (
    ...
    WHERE
        ...
        AND t1.ga4_user_privacy_info_ads_storage IS NOT NULL
        AND t1.rn = 1
),
...
final AS (
    SELECT
        ...
        t2.ga4_user_privacy_info_ads_storage
    FROM
        t2
)
