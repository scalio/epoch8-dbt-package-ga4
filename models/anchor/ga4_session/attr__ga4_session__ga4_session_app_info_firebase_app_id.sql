...
WITH t1 AS (
    SELECT
        ...
        events.app_info.firebase_app_id AS ga4_session_app_info_firebase_app_id,
...
t2 AS (
    ...
    WHERE
        ...
        AND t1.ga4_session_app_info_firebase_app_id IS NOT NULL
...
t3 AS (
    SELECT
        ...
        t2.ga4_session_id,
        t2.ga4_session_app_info_firebase_app_id,
...
final AS (
    SELECT
        ...
        t3.ga4_session_id,
        t3.ga4_session_app_info_firebase_app_id,
