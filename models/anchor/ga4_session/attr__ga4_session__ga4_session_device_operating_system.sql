...
WITH t1 AS (
    SELECT
        ...
        events.device.operating_system AS ga4_session_device_operating_system,
...
t2 AS (
    ...
    WHERE
        ...
        AND t1.ga4_session_device_operating_system IS NOT NULL
...
t3 AS (
    SELECT
        ...
        t2.ga4_session_id,
        t2.ga4_session_device_operating_system,
...
final AS (
    SELECT
        ...
        t3.ga4_session_id,
        t3.ga4_session_device_operating_system,
