...
WITH t1 AS (
    SELECT
        ...
        events.device.web_info.browser AS ga4_session_device_web_info_browser,
...
t2 AS (
    ...
    WHERE
        ...
        AND t1.ga4_session_device_web_info_browser IS NOT NULL
...
t3 AS (
    SELECT
        ...
        t2.ga4_session_id,
        t2.ga4_session_device_web_info_browser,
...
final AS (
    SELECT
        ...
        t3.ga4_session_id,
        t3.ga4_session_device_web_info_browser,
