...
WITH t1 AS (
    SELECT
        ...
        events.app_info.install_source AS ga4_session_app_info_install_source
    FROM
...
t2 AS (
    ...
    WHERE
        ...
        AND t1.ga4_session_app_info_install_source IS NOT NULL
),
...
t3 AS (
    SELECT
        ...
        t2.ga4_session_app_info_install_source
    FROM
        t2
    WHERE
        t2.rn = 1
...
final AS (
    SELECT
        ...
        t3.ga4_session_app_info_install_source
    FROM
        t3
)
