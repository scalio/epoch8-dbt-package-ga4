...
WITH t1 AS (
    SELECT
        ...
        events.device.is_limited_ad_tracking AS ga4_session_device_is_limited_ad_tracking,
...
t2 AS (
    ...
    WHERE
        ...
        AND t1.ga4_session_device_is_limited_ad_tracking IS NOT NULL
...
t3 AS (
    SELECT
        ...
        t2.ga4_session_id,
        t2.ga4_session_device_is_limited_ad_tracking,
...
final AS (
    SELECT
        ...
        t3.ga4_session_id,
        t3.ga4_session_device_is_limited_ad_tracking,
