...
WITH t1 AS (
    SELECT
        ...
        events.device.language AS ga4_session_device_language
    FROM
...
t2 AS (
    ...
    WHERE
        ...
        AND t1.ga4_session_device_language IS NOT NULL
),
...
t3 AS (
    SELECT
        ...
        t2.ga4_session_device_language
    FROM
        t2
    WHERE
        t2.rn = 1
...
final AS (
    SELECT
        ...
        t3.ga4_session_device_language
    FROM
        t3
)
