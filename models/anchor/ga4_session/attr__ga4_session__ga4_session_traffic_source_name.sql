...
WITH t1 AS (
    SELECT
        ...
        events.traffic_source.name AS ga4_session_traffic_source_name,
...
t2 AS (
    ...
    WHERE
        ...
        AND t1.ga4_session_traffic_source_name IS NOT NULL
...
t3 AS (
    SELECT
        ...
        t2.ga4_session_id,
        t2.ga4_session_traffic_source_name,
...
final AS (
    SELECT
        ...
        t3.ga4_session_id,
        t3.ga4_session_traffic_source_name,
