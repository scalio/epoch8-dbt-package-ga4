...
WITH t1 AS (
    SELECT
        ...
        events.device.mobile_os_hardware_model AS ga4_session_device_mobile_os_hardware_model,
...
t2 AS (
    ...
    WHERE
        ...
        AND t1.ga4_session_device_mobile_os_hardware_model IS NOT NULL
...
t3 AS (
    SELECT
        ...
        t2.ga4_session_id,
        t2.ga4_session_device_mobile_os_hardware_model,
...
final AS (
    SELECT
        ...
        t3.ga4_session_id,
        t3.ga4_session_device_mobile_os_hardware_model,
