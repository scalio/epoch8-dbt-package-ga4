...
WITH t1 AS (
    SELECT
        ...
        events.app_info.version AS ga4_session_app_info_version,
...
t2 AS (
    ...
    WHERE
        ...
        AND t1.ga4_session_app_info_version IS NOT NULL
...
t3 AS (
    SELECT
        ...
        t2.ga4_session_id,
        t2.ga4_session_app_info_version,
...
final AS (
    SELECT
        ...
        t3.ga4_session_id,
        t3.ga4_session_app_info_version,
