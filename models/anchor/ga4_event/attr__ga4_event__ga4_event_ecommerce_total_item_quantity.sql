...
WITH t1 AS (
    SELECT DISTINCT
        ...
        events.ecommerce.total_item_quantity AS ga4_event_ecommerce_total_item_quantity
    FROM
...
t2 AS (
    ...
    WHERE
        ...
        AND t1.ga4_event_ecommerce_total_item_quantity IS NOT NULL
),
...
final AS (
    SELECT
        ...
        t2.ga4_event_id,
        t2.ga4_event_ecommerce_total_item_quantity
    FROM
        t2
)
