...
WITH t1 AS (
    SELECT DISTINCT
        ...
        events.ecommerce.tax_value_in_usd AS ga4_event_ecommerce_tax_value_in_usd
    FROM
...
t2 AS (
    ...
    WHERE
        ...
        AND t1.ga4_event_ecommerce_tax_value_in_usd IS NOT NULL
),
...
final AS (
    SELECT
        ...
        t2.ga4_event_id,
        t2.ga4_event_ecommerce_tax_value_in_usd
    FROM
        t2
)
