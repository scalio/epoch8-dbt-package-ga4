...
WITH t1 AS (
    SELECT DISTINCT
        ...
        events.ecommerce.unique_items AS ga4_event_ecommerce_unique_items
    FROM
...
t2 AS (
    ...
    WHERE
        ...
        AND t1.ga4_event_ecommerce_unique_items IS NOT NULL
),
...
final AS (
    SELECT
        ...
        t2.ga4_event_id,
        t2.ga4_event_ecommerce_unique_items
    FROM
        t2
)
