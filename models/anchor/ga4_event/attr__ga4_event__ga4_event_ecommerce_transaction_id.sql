...
WITH t1 AS (
    SELECT DISTINCT
        ...
        events.ecommerce.transaction_id AS ga4_event_ecommerce_transaction_id
    FROM
...
t2 AS (
    ...
    WHERE
        ...
        AND t1.ga4_event_ecommerce_transaction_id IS NOT NULL
),
...
final AS (
    SELECT
        ...
        t2.ga4_event_id,
        t2.ga4_event_ecommerce_transaction_id
    FROM
        t2
)
