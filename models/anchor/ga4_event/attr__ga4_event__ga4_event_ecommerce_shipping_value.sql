...
WITH t1 AS (
    SELECT DISTINCT
        ...
        events.ecommerce.shipping_value AS ga4_event_ecommerce_shipping_value
    FROM
...
t2 AS (
    ...
    WHERE
        ...
        AND t1.ga4_event_ecommerce_shipping_value IS NOT NULL
),
...
final AS (
    SELECT
        ...
        t2.ga4_event_id,
        t2.ga4_event_ecommerce_shipping_value
    FROM
        t2
)
